return {
	-- HACK: docs @ https://github.com/folke/snacks.nvim/blob/main/docs
	{
		...
		keys = {
			...
			-- Snacks Picker
			{ "<leader>f",        function() require("snacks").picker.files() end,                                   desc = "Find Files (Snacks Picker)" },
			...
			{ "<leader>fgw",      function() require("snacks").picker.grep_word() end,                               desc = "Search Visual selection or Word",  mode = { "n", "x" } },
